...
#@ File(label="Shading correction model",description="single slice, single channel, 32-bit float TIFF file, specify 'NONE' or '-' for no shading correction",style="extensions:tif/tiff") model_file
